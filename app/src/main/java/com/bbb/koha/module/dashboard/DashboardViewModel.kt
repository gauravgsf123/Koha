...
import com.bbb.koha.module.dashboard.model.PlaceHoldResponseModel
        ...
        if (Utils.hasInternetConnection(mContext)) {
            ...
            viewModelScope.launch {
                ...
                response?.body()?.forEach { it ->
                    ...
                    it.bookDetailResponseModel = bookResponse
                    val bookImageResponse =repository.getBookImageDetail("isbn:${Utils.getNumber(bookResponse?.isbn!!)}")
                    it.bookDetailModel = bookImageResponse
                }
